...
int main(int argc, char * argv[])
{
	...
	char dieu8ynsh[8];// antikatastash me int
	char leitourgia; // den xreiazetai
	...
	do{
		...
		int metrhthsGiaToQ = 0; //i
		//int j=0;
		while( metrhthsGiaToQ < q ) // i< EOF
		{
			...
			pros8eseSelidaStoPageTable			 
	(pageTable,plh8osSelidwnMnhmhs,ari8mosSelidas,leitourgia,methodosAntikatastashs,para8yro); // pros8ese th selida sth mnhmh
